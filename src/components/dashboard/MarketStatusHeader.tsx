...
const MarketStatusHeader: React.FC<MarketStatusHeaderProps> = ({
    ...
    return (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 mb-6 md:mb-8">
            {/* 1. Total Equity */}
            <div className="glass-panel p-3 md:p-4 rounded-xl border border-white/10 flex items-center gap-3 md:gap-4 relative overflow-hidden group">
                ...
                <div className="p-2 md:p-3 bg-accent/10 rounded-lg text-accent">
                    <Wallet size={20} className="md:w-6 md:h-6" />
                </div>
                <div>
                    <p className="text-gray-400 text-[10px] md:text-xs font-bold uppercase">Capital Total</p>
            ...
            <div className="glass-panel p-3 md:p-4 rounded-xl border border-white/10 flex flex-col gap-2 md:gap-3">
